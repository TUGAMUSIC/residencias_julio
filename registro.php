...
if(isset($_POST['btn-save']))
{
  ...
  $Turno=$_POST['turno_id'];
	...
	$sql_query="INSERT INTO alumnos (`matricula_id`, `nombre_id`,`ap_id`,`am_id`, `Psswrd_id`, `carrera_id`, `turno_id`) VALUES ('".$Matricula."','".$Nombre."','".$Paterno."','".$Materno."','".$Psswrd."','".$Carrera."','".$Turno."')";
...
<div class="cover-caption">
  <div class="containe">
      ...
      <form method="post" enctype="multipart/form-data" class="row ustify-content-left"></br>
        <div class="form-group col-md-9 conjunto1"> 
          <label for=""><b>Nombre(s)</b></label></br>
            <input type="text" class="form-control campo2" id="nombre_id" name="nombre_id"
						required placeholder="Nombre">
        </div>    
        <div class="form-group col-md-9 conjunto1">
          <label for=""><b>Apellido Paterno</b></label>
            <input type="text" class="form-control campo2" id="ap_id" name="ap_id"
						required placeholder="Apellido Paterno">
        </div>                                       
        <div class="form-group col-md-9 conjunto1"> 
            <label for=""><b>Apellido Materno</b></label>
            <input type="text" class="form-control campo2" id="am_id" name="am_id"
						required placeholder="Apellido Materno">
        </div>    
        <div class="form-group col-md-9 conjunto1"> 
            <label for=""><b>Matricula</b></label>
            <input type="number" class="form-control campo2" id="matricula_id" name="matricula_id"
						required placeholder="Matricula" maxlength="9">
        </div>
        <div class="form-group col-md-9 conjunto1"> 
            <label for=""><b>Contraseña</b></label>
            <input type="password" class="form-control campo2" id="Psswrd_id" name="Psswrd_id"
						required placeholder="Contraseña">
        </div>                                          
        <div class="form-group col-md-9 conjunto1"> <!-- State Button -->
    ...
    <div class="form-group"> 
            <center><button type="submit" name="btn-save" class="btn btn-xs bGuardar">Registrarse</button></center>
